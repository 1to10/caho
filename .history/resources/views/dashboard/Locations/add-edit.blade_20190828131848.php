...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ env('APP_URL') }}/dashboard/locations">Location Management</a></li>
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="{{ env('APP_URL') }}/dashboard/locations" class="btn btn-danger btn-xs"><i class="fa fa-arrow-left"></i></a>

        </div>
      </div>
      @empty($articles)
        <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/locations/add/new" enctype="multipart/form-data">
          @endempty

          @isset($articles)
            <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/locations/edit/{{$articles->id}}" enctype="multipart/form-data">
              @endisset
