    ...
    <div class="box-body">
      ...
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a href="#RegistrationDetail" data-toggle="tab">Feedbacks details</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="fixed-sec">
                        <a href="{{ env('APP_URL') }}/dashboard/registrations/{{ $article->id }}/delete" onClick="return confirm('Are you sure you want to delete record!');">Delete</a>
