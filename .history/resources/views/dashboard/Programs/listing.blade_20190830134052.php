                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($articles as $article)
                        <tr class="odd gradeX">
                            ...
                            <td ><a href="{{ env('APP_URL') }}/dashboard/registrations?cat_id={{ $article->cat_id }}">{{  $article->cat_id }}</a> </td>
                            <td> <a href="{{ env('APP_URL') }}/dashboard/registrations?location={{ $article->location }}"> {{  $article->location }}</a></td>
