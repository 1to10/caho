        ...
        <form>
          <select name="cat_id">
            ...
            @foreach($categorylist as $slug=>$singlecat)
              <option value="{{$slug}}">{{$singlecat}}</option>
            @endforeach
          </select>
          <select name="program">
            <option value="">Select Program</option>
            @foreach($programlist as $slug=>$singleprogm)
              <option value="{{$slug}}">{{$singleprogm}}</option>
            @endforeach
          </select>
          <select name="city">
            <option value="">Select City</option>
            @foreach($citylist as $singlecity)
              <option value="{{$singlecity->city}}">{{$singlecity->city}}</option>
            @endforeach
          </select>
          <select name="state">
          ...
          <select name="location">
            ...
            @foreach($program_locationlist as $singlelocation)
              <option value="{{$singlelocation->program_location}}">{{$singlelocation->program_location}}</option>
            @endforeach
          </select>
