            ...
            <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/registrations/edit/{{$articles->id}}" enctype="multipart/form-data">
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('applied_for_sub_cat') ? ' has-error' : '' }}">
                            <label>Applied for (Subcategory) <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="applied_for_sub_cat" type="text" class="form-control" name="applied_for_sub_cat" value="{{ isset($articles->applied_for_sub_cat) ? $articles->applied_for_sub_cat : old('applied_for_sub_cat') }}" required autofocus>
                            </div>
                            @if ($errors->has('applied_for_sub_cat'))
                              <span class="help-block">
                                              <strong>{{ $errors->first('applied_for_sub_cat') }}</strong>
                                          </span>
                            @endif
                          </div>
                    </div>
