                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('exp_in_quality') ? ' has-error' : '' }}">
                            <label>exp_in_quality <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                ...
                <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group {{ $errors->has('catid') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                <select name="facultylist_iddata" id="facultylist_id" class="form-control"  autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('catid') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                <select name="lablist_iddata[]" id="lablist_id" class="form-control"  autofocus>
