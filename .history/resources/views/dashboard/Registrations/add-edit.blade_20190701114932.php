...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ env('APP_URL') }}/dashboard/programs">Programs Management</a></li>
      <li><a href="#">Programs Add / Edit</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">Programs Add / Edit</h3>
                                ...
                                <select name="facultylist_iddata[]" id="facultylist_id" class="form-control select2"  autofocus multiple="multiple">
                                  ...
                                  @php 
                                    ...
                                    if(isset($articles->facultylist_id))
                                    {
                                      ...
                                      {
                                        $programslistarray = explode(',',$articles->facultylist_id);
                                      
                                        if(in_array($catid,$programslistarray))
                                        {
                                          $selected='selected';
                                        }
                                      }
                                ...
                                <select name="lablist_iddata[]" id="lablist_id" class="form-control select2"  autofocus multiple="multiple">
                                  ...
                                  @php 
                                    ...
                                    if(isset($articles->lablist_id))
                                    {
                                      ...
                                      {
                                        $programslistarray = explode(',',$articles->lablist_id);
...
<div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
 ...
 @endif
                ...
                <div class="row">
                  ...
                  <h3>Add Courses</h3>
                  <div class="row">
                      <input type="hidden" id="course_cnt" value="@if($courseslist) {{ $courseslist->count() }} @else 1 @endif">
                      <div class="input_fields_wrap">
                                       ...
                                       @if($courseslist) 
                                        ...
                                        @foreach($courseslist as $singleinfo)

                                      <div class="col-md-12">
                                        <input type="hidden" name="programdataid[]" value="{{ $singleinfo->id}}">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <div class="input-group">
                                                  <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                                  <input  type="text" class="form-control" name="featurestitle[]" value="{{ $singleinfo->name}}"  autofocus>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                  <span class="input-group-btn">
                                                    <a  data-input="imgdata3{{ $singleinfo->id}}" data-preview="holder3{{ $singleinfo->id}}" class="btn btn-primary lfm">
                                                    <i class="fa fa-picture-o"></i> Choose</a>
                                                  </span>
                                                  <input id="imgdata3{{ $singleinfo->id}}"  value="{{$singleinfo->img}}" class="form-control" type="text" name="featureimg[]">
                                                </div>
                                              <img id="holder3{{ $singleinfo->id}}" style="margin-top:15px;max-height:100px;" @if($singleinfo->img) src="{{env('APP_URL')}}{{ $singleinfo->img }}" @endif/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                  <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                                  <input  type="number" class="form-control" name="featuresorder[]" value="{{ $singleinfo->ordering}}"  autofocus>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <div class="form-group">
                                                  ...
                                                  <div class="input-group">
                                                    <span class="input-group-btn">
                                                      <a  data-input="imgdata3" data-preview="holder3" class="btn btn-primary lfm" id="lfm3">
                                                      <i class="fa fa-picture-o"></i> Choose</a>
                                                    </span>
                                                    <input id="imgdata3"  value="" class="form-control" type="text" name="featureimg[]">
                                                  </div>
                                          ...
                                          <div class="col-md-4">
                                              <div class="form-group">
                                                  ...
                                                  <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                                    <input  type="number" class="form-control" name="featuresorder[]" value="1"  autofocus>
                                                  </div>
                      ...
                      <button class="add_field_button">Add More Course</button>
                  </div>
