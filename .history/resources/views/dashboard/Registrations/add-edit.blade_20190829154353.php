                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
                            <label>last_name <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('cv_to_be') ? ' has-error' : '' }}">
                          <label>CV to be uploaded (Full Path) ? <span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="cv_to_be" type="text" class="form-control" name="cv_to_be" value="{{ isset($articles->cv_to_be) ? $articles->cv_to_be : old('cv_to_be') }}" required autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('photograph') ? ' has-error' : '' }}">
                            <label>Photograph to be uploaded (Full Path) ? <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="photograph" type="text" class="form-control" name="photograph" value="{{ isset($articles->photograph) ? $articles->photograph : old('photograph') }}" required autofocus>
                            </div>
