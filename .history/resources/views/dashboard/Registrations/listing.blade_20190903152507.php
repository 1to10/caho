      ...
      <div class="box box-default">
            <div class="box-header with-border flex">
                  ...
                  <div class="box-tools pull-right">
                        ...
                        <a href="javascript:act_rec('{{ env('APP_URL') }}/dashboard/registrations');"><button class="btn-info big-btn" title="Publish">Download
                              ...
                              <div class="tab-pane active" id="RegistrationDetail">
                                    ...
                                    <div class="filter_boxes">
                                          ...
                                          <form>
                                               ...
                                               <input type="hidden" name="programstatus">
                                                <div class="row">
                                                ...
                                                <table id="example1" class="table table-bordered table-striped">
                                                      <thead>
                                                            <tr>
                                                                  ...
                                                                  <th class="fixed-sec" width="12%">Approved</th>
                                                            </tr>
                                                      </thead>
                                                      <tbody>
                                                            ...
                                                            <tr class="odd gradeX">
                                                                  ...
                                                                  <td class="center flex">
                                                                        ...
                                                                        @if($article->status == 1)
                                                                        <a id="{{  $article->id }} active" class="pub_unpub" href="{{ env('APP_URL') }}/dashboard/registrations/{{$article->id}}/deactivate"
                                                                              onclick="return confirm('Are you sure you want to Inactivate record!');"><img src="{{asset('backend/assets/images/tick-circle.gif')}}" width="16" height="16" border="0"
                                                                                    title="Make Active" /></a>
                                                                        @else
                                                                        <a id="{{  $article->id }} inactive" class="pub_unpub" href="{{ env('APP_URL') }}/dashboard/registrations/{{$article->id}}/activate"
                                                                              onclick="return confirm('Are you sure you want to Activate record!');"><img src="{{asset('backend/assets/images/unpublish.gif')}}" width="16" height="16" border="0"
                                                                                    title="Make Inactive" /></a>
                                                                        @endif
                                                                        ...
                                                                        <a href="{{ env('APP_URL') }}/dashboard/registrations/{{ $article->id }}/destroy" onClick="return confirm('Are you sure you want to delete record!');"><i
                                                                                    class="fa fa-trash-o fa-fw"></i></a>

                                                                  </td>
                                                                  <td class="fixed-sec"><a href="#">Approved</a></td>
                                                            </tr>
                                                            @endforeach
