                ...
                <ul class="treeview-menu">
                        <li class="treeview"><a href="#"><i class="fa fa-list fa-fw"></i>  Current Events </a>
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ env('APP_URL') }}/dashboard/registrations?programstatus=current"><i class="fa fa-list fa-fw"></i>  CAHOTECH 2019 </a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                    ...
                                    <li><a href="{{ env('APP_URL') }}/dashboard/registrations?programstatus=current"><i class="fa fa-list fa-fw"></i>   CAHOTECH </a></li>
