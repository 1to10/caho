    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <a href="#"><i class="fa fa-tasks fa-fw"></i> <span>Categories Mgmt</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
            ...
            <li class="treeview">
                ...
                <a href="#"><i class="fa fa-map-marker fa-fw"></i> <span>Programs Mgmt</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>

                <ul class="treeview-menu">

                        <li><a href="{{ env('APP_URL') }}/dashboard/programs"><i class="fa fa-list fa-fw"></i> Programs Listing</a></li>
                </ul>
            </li>

            <li class="treeview">

            <a href="#"><i class="fa fa-map-marker fa-fw"></i> <span>Registrations Mgmt</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>

            <ul class="treeview-menu">

                    <li><a href="{{ env('APP_URL') }}/dashboard/registrations"><i class="fa fa-list fa-fw"></i> Registrations Listing</a></li>
            </ul>
            </li>
