<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
                ...
                <ul class="treeview-menu">
                        <li class="treeview"><a href="#"><i class="fa fa-list fa-fw"></i>  Current Events </a>
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ env('APP_URL') }}/dashboard/cahotech?programstatus=current"><i class="fa fa-list fa-fw"></i>  CAHOTECH 2019 </a></li>
                                <li><a href="{{ env('APP_URL') }}/dashboard/cahocon?programstatus=current"><i class="fa fa-list fa-fw"></i>  CAHOCON 2019 </a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                    ...
                                    <li><a href="{{ env('APP_URL') }}/dashboard/cahotech?programstatus=past"><i class="fa fa-list fa-fw"></i>   CAHOTECH </a></li>
                                    <li><a href="{{ env('APP_URL') }}/dashboard/cahocon?programstatus=past"><i class="fa fa-list fa-fw"></i>   CAHOCON </a></li>
                            </ul>
            ...
            <!-- <li class="treeview">
                <a href="{{ env('APP_URL') }}/dashboard/membership"><i class="fa fa-calendar-o fa-fw"></i> <span>Membership</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
                <li><a href="{{ env('APP_URL') }}/dashboard/member-registrations/1">
                                    <i class="fa fa-list fa-fw"></i>Regular Membership Institution</a>
                                </li>
                                <li><a href="{{ env('APP_URL') }}/dashboard/member-registrations/2">
                                    <i class="fa fa-list fa-fw"></i>Associate Membership Institution</a>
                                </li>
                                <li><a href="{{ env('APP_URL') }}/dashboard/member-registrations/3">
                                    <i class="fa fa-list fa-fw"></i>  Associate Membership Individual</a>
                                </li>
            ...
            <li>
                <a href="{{ env('APP_URL') }}/dashboard/membership">
                    <i class="fa fa-money"></i> <span>Membership</span>
                </a>
            </li>
