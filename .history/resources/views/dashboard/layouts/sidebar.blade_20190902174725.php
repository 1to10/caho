<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#"><i class="fa fa-map-marker fa-fw"></i> <span>TP Management</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
                        <li class="treeview"><a href="#"><i class="fa fa-list fa-fw"></i>  Current Programs </a>
                            <ul class="treeview-menu">
                                <li><a href="{{ env('APP_URL') }}/dashboard/categories"><i class="fa fa-list fa-fw"></i> Program Category with locations </a></li>
                                <li><a href="{{ env('APP_URL') }}/dashboard/registrations/current"><i class="fa fa-list fa-fw"></i> All Registrations with filters and download </a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-list fa-fw"></i>   Past programs </a>
                             ...
                             <ul class="treeview-menu">
                                <li><a href="{{ env('APP_URL') }}/dashboard/registrations/past"><i class="fa fa-list fa-fw"></i> All Registrations </a></li>
                            </ul>
            ...
            <li class="treeview">
             ...
             <li>
                <a href="{{ env('APP_URL') }}/dashboard/registrations">
                    <i class="fa fa-dashboard"></i> <span>Enquiry Form</span>
                </a>
            </li>
