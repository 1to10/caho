    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <a href="#"><i class="fa fa-map-marker fa-fw"></i> <span>Location Mgmt</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>

                <ul class="treeview-menu">

                        <li><a href="{{ env('APP_URL') }}/dashboard/locations"><i class="fa fa-list fa-fw"></i> Location Listing</a></li>
                </ul>
            </li>
