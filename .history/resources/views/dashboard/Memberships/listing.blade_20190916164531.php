...
@if(session('error'))
  ...
  <div class="row flex">
    ...
    $i++;
    @endphp
    <div class="col-lg-4 col-xs-6 programCat" style="height:650px;"> 
      <!-- small box -->
      <div class="small-box bg-{{$color[$index]}}">
        ...
        <div class="contentdesc" style="margin-top:20px;">
          {!! $article->description !!} <br/>
          <a href="{{ env('APP_URL') }}/dashboard/member-registrations/edit/{{ $article->id }}" class="small-box-footer pro-cat-footer" style="color:#fff;margin-left:10px;">View Registration</a>
        </div>
