...
@section('content')
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      @empty($articles)
        <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/membership/add/new" enctype="multipart/form-data">
          @endempty

          @isset($articles)
            <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/membership/edit/{{$articles->id}}" enctype="multipart/form-data">
              @endisset
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="form-group {{ $errors->has('img') ? ' has-error' : '' }}">
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                              <input id="img" type="text" class="form-control" name="img" value="{{ isset($articles->img) ? $articles->img : old('img') }}"  autofocus>
                              </div>
                              @if ($errors->has('img'))
                                <span class="help-block">
