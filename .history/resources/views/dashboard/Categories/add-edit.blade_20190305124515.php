...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ env('APP_URL') }}/dashboard/categories">Category Management</a></li>
      <li><a href="#">Category Add / Edit</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">Category Add / Edit</h3>

        <div class="box-tools pull-right">

          <a href="{{ env('APP_URL') }}/dashboard/categories" class="btn btn-danger btn-xs"><i class="fa fa-arrow-left"></i></a>

        </div>
      </div>
      @empty($articles)
        <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/categories/add/new" enctype="multipart/form-data">
          @endempty

          @isset($articles)
            <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/categories/edit/{{$articles->id}}" enctype="multipart/form-data">
              @endisset
                ...
                <div class="row">
                  <div class="col-md-6">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-btn"><a  data-input="imgdata" data-preview="holder" class="btn btn-primary" id="lfm"><i class="fa fa-picture-o"></i> Choose</a></span>
                        <input id="imgdata"  value="{{(isset($articles->banner_img))?$articles->banner_img:''}}" class="form-control" type="text" name="banner_img">
                      </div>
                      <img id="holder" style="margin-top:15px;max-height:100px;" @if(isset($articles->banner_img)) src="{{ env('APP_URL') }}{{ $articles->banner_img}}" @endif />
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('cat_slug') ? ' has-error' : '' }}">
                      <label>Slug <span class="error">*</span></label>
                      <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                      <input id="cat_slug" type="text" class="form-control" name="cat_slug" value="{{ isset($articles->cat_slug) ? $articles->cat_slug : old('cat_slug') }}" required autofocus>
                      </div>
                      @if ($errors->has('cat_slug'))
                        <span class="help-block">
                                        <strong>{{ $errors->first('cat_slug') }}</strong>
                                    </span>
                      @endif
                    </div>
                    <!-- /.form-group -->
                     ...
                     <div class="form-group" >
                      ...
                      <textarea id="article-ckeditor"  name="cat_desc" class="form-control">{{ isset($articles->cat_desc) ? $articles->cat_desc : old('cat_desc') }}</textarea>
                    </div>
