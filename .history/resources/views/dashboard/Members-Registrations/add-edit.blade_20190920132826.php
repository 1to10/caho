...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ env('APP_URL') }}/dashboard/member-registrations">registrations Management</a></li>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      @empty($articles)
        <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/member-registrations/add/new" enctype="multipart/form-data">
          @endempty

          @isset($articles)
            <form role="form" method="POST" action="{{ env('APP_URL') }}/dashboard/member-registrations/edit/{{$articles->id}}" enctype="multipart/form-data">
              @endisset
