                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('ceo_email') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="ceo_email" type="text" class="form-control" name="ceo_email	" value="{{ isset($articles->areaof_interest) ? $articles->areaof_interest : old('areaof_interest') }}"  autofocus>
                            </div>
