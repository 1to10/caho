                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('pincode') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="pincode" type="text" class="form-control" name="pincode" value="{{ isset($articles->pincode) ? $articles->pincode : old('pincode') }}" required autofocus>
                            </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('org_type') ? ' has-error' : '' }}">
                            <label>ORGANIZATION / SELF EMPLOYED <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="org_type" type="text" class="form-control" name="org_type" value="{{ isset($articles->org_type) ? $articles->org_type : old('org_type') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('organization_name') ? ' has-error' : '' }}">
                          <label>NAME OF THE ORGANIZATION <span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="organization_name" type="text" class="form-control" name="organization_name" value="{{ isset($articles->organization_name) ? $articles->organization_name : old('organization_name') }}" required autofocus>
                          </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('role') ? ' has-error' : '' }}">
                          ...
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="role" type="text" class="form-control" name="role" value="{{ isset($articles->role) ? $articles->role : old('role') }}" required autofocus>
                          </div>
                          @if ($errors->has('role'))
                            <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('areaof_interest') ? ' has-error' : '' }}">
                            <label>AREA OF INTEREST <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="areaof_interest" type="text" class="form-control" name="areaof_interest" value="{{ isset($articles->areaof_interest) ? $articles->areaof_interest : old('areaof_interest') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('domain') ? ' has-error' : '' }}">
                          <label>DOMAIN <span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="domain" type="text" class="form-control" name="domain" value="{{ isset($articles->domain) ? $articles->domain : old('domain') }}" required autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('state') ? ' has-error' : '' }}">
                            <label>MEMBERSHIP TYPE <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="state" type="text" class="form-control" name="state" value="{{ isset($articles->state) ? $articles->state : old('state') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                          ...
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="amount" type="text" class="form-control" name="amount" value="{{ isset($articles->amount) ? $articles->amount : old('amount') }}" required autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('MemberValidity') ? ' has-error' : '' }}">
                            <label>Member Validity <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="MemberValidity" type="date" class="form-control" name="MemberValidity" value="{{ isset($articles->MemberValidity) ? $articles->MemberValidity : old('MemberValidity') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('MembershipStatus') ? ' has-error' : '' }}">
                          <label>Membership Status <span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="MembershipStatus" type="text" class="form-control" name="MembershipStatus" value="{{ isset($articles->MembershipStatus) ? $articles->MembershipStatus : old('MembershipStatus') }}" required autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('OrderId') ? ' has-error' : '' }}">
                            <label>OrderId <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="OrderId" type="text" class="form-control" name="OrderId" value="{{ isset($articles->OrderId) ? $articles->OrderId : old('OrderId') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('OrderStatus') ? ' has-error' : '' }}">
                          <label>Order Status <span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="OrderStatus" type="text" class="form-control" name="OrderStatus" value="{{ isset($articles->OrderStatus) ? $articles->OrderStatus : old('OrderStatus') }}" required autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('Transactionid') ? ' has-error' : '' }}">
                            <label>Transaction id <span class="error">*</span></label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="Transactionid" type="text" class="form-control" name="Transactionid" value="{{ isset($articles->Transactionid) ? $articles->Transactionid : old('Transactionid') }}" required autofocus>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('StatusMessage') ? ' has-error' : '' }}">
                          <label>Status Message<span class="error">*</span></label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="StatusMessage" type="text" class="form-control" name="StatusMessage" value="{{ isset($articles->StatusMessage) ? $articles->StatusMessage : old('StatusMessage') }}" required autofocus>
                          </div>
