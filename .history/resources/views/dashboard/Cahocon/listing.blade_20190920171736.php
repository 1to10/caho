  ...
  <div class="box box-default">
    <div class="box-header with-border flex">
      ...
      <div class="box-tools pull-right">
        <!-- <a href="{{ env('APP_URL') }}/dashboard/cahocon/add/new"><button class="btn-success big-btn" title="Add registrations">+ Create New
           
          </button></a> -->
        <a href="javascript:act_rec('{{ env('APP_URL') }}/dashboard/cahocon');"><button class="btn-info big-btn excell-icon" title="Publish">Download
          
          </button></a>

          <!-- <a href="javascript:act_rec('{{ env('APP_URL') }}/dashboard/cahocon');"><button class="btn-info big-btn" title="Publish">Publish
           
          </button></a>
        <a href="javascript:inact_rec('{{ env('APP_URL') }}/dashboard/cahocon');"><button class="btn-warning big-btn" title="Unpublish">Unpublish
           
          </button></a> -->
        <a href="javascript:del_rec('{{ env('APP_URL') }}/dashboard/cahocon');"><button class="btn-danger big-btn" title="Delete">Delete
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="center flex">
                        ...
                        <a href="{{ env('APP_URL') }}/dashboard/cahocon/{{ $article->id }}/destroy" onClick="return confirm('Are you sure you want to delete record!');"><i class="fa fa-trash-o fa-fw"></i></a>
