...
{
    $program_locationlist = Registrations::select('program_location')->where('applied_for','=',$catcode)->distinct()->orderby('program_location','ASC')->get();
    print_r($program_locationlist);
