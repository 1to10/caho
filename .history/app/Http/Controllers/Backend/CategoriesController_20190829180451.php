...
class CategoriesController extends Controller
{
    ...
    public function __construct(){
        ...
        $this->categorylist = Category::where([['status','=',1],['parent_id','=',0]])->pluck('title', 'id');
    }
    ...
    public function Add()
    {
        ...
        return view('dashboard.Categories.add-edit', compact('acategorys','categorylist'));
    ...
    public function GetEdit(Request $request , $id)
    {
       ...
       $acategorys="";
       $categorylist =  $this->categorylist;
        return 	view('dashboard.Categories.add-edit',compact('acategorys','articles','categorylist'));
    }
