...
class RegistrationsController extends Controller
{
    ...
    public function listing(Request $request)
    {
        ...
        if(isset($input['state']))
        {
         ...
         $citylist = Registrations::select('city')->distinct()->get();
         $statelist = Registrations::select('state')->distinct()->get();
         $program_locationlist = Registrations::select('program_location')->distinct()->get();
        
        return 	view('dashboard.Registrations/listing',['articles'=>$artlist,'categorylist'=>$categorylist,
        'programlist'=>$programlist,'citylist'=>$citylist,'statelist'=>$statelist,'program_locationlist'=>$program_locationlist]);
    }
