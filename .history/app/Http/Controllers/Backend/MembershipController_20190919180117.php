...
class MembershipController extends Controller
{
    ...
    public function listing()
    {
        ...
        $plan1_member = MembershipRegistrations::where('MembershipStatus','LIKE','%Active%')->count();
        $plan1_member = MembershipRegistrations::where('MembershipStatus','LIKE','%EXPIRED%')->count();
