...
class MemberRegistrationsController extends Controller
{
    ...
    public function Add(Request $request , $membershipid)
    {
        ...
        return view('dashboard.Members-Registrations.add-edit', compact('courseslist','categorylist','programlist','membershipid'));
    ...
    public function GetEdit(Request $request , $membershipid, $id)
    {
       ...
       // dd($courseslist);
         $categorylist =  $this->categorylist;
         $programlist =  $this->programlist;
        return 	view('dashboard.Members-Registrations.add-edit',compact('articles','courseslist','categorylist','programlist','membershipid'));
    }
