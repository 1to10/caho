...
class MemberRegistrationsController extends Controller
{
    ...
    public function PostEdit(Request $request , $id)
    {
        ...
        if($validator->fails())
        {
            return redirect('dashboard/registrations/'.$membershipid.'/'.$id)
                ->withErrors($validator)
                ->withInput();
        }
        //update post data
        ...
        return redirect('dashboard/registrations/'.$membershipid)->with('success', 'Registration Update Successfully');
    }
