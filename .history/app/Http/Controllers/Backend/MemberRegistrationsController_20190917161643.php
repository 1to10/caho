...
class MemberRegistrationsController extends Controller
{
    ...
    public function listing(Request $request , $membershipid)
    {
        ...
        $input = $request->all();
        $program='';$classification='';$location='';$city='';$state='';$programstatus='';
       ...
       'citylist'=>$citylist,'statelist'=>$statelist,
        'program_locationlist'=>$program_locationlist,'program'=>$program,'classification'=>$classification,'location'=>$location,'city'=>$city
