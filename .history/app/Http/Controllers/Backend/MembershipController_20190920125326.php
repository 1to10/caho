...
class MembershipController extends Controller
{
    ...
    public function listing()
    {
        ...
        $today = date('Y-m-d');
        $activecnt = MembershipRegistrations::whereRaw('DATE(MemberValidity) >=$today')->count();
        $expiredcnt = MembershipRegistrations::whereRaw('MemberValidity','LIKE','%EXPIRED%')->count();

        return 	view('dashboard.Memberships/listing',['articles'=>$artlist,'array_number'=>$array_number,'activecnt'=>$activecnt,'expiredcnt'=>$expiredcnt]);
    }
