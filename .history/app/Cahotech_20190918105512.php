...
class Cahotech extends Model
{
    ...
    'workshop','amount','order_id','order_status','status_message','tracking_id','reference_id','regorderno','student_file','regcert_file','registered_on','created_at','updated_at'];
}
