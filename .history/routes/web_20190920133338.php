...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/member-registrations/{id}/activate', ['uses' => 'MemberRegistrationsController@activate']);
    Route::get('/member-registrations/{id}/deactivate', ['uses' => 'MemberRegistrationsController@deactivate']);
    Route::get('/member-registrations/{id}/destroy', ['uses' => 'MemberRegistrationsController@destroy']);

    Route::get('/member-registrations/{action}', array( 'uses' => 'MemberRegistrationsController@GetBulkAction'));
    Route::post('/member-registrations/{action}', array( 'uses' => 'MemberRegistrationsController@PostBulkAction'));
