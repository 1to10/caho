...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/member-registrations/add/new', array( 'uses' => 'MemberRegistrationsController@Add'));
    Route::post('/member-registrations/add/new', array( 'uses' => 'MemberRegistrationsController@postdata'));
    ...
    Route::get('/cahocon', array( 'uses' => 'CahotechController@conlisting'));
