...
Route::group(array('namespace'=>'FrontEnd'), function(){
    ...
    Route::post('savecategory', 'AjaxController@savecategory');
...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/locations', array( 'uses' => 'LocationsController@listing'));

    Route::get('/locations/add/new', array( 'uses' => 'LocationsController@Add'));
    Route::post('/locations/add/new', array( 'uses' => 'LocationsController@postdata'));

    Route::get('/locations/edit/{id}', array( 'uses' => 'LocationsController@GetEdit'));
    Route::post('/locations/edit/{id}', array( 'uses' => 'LocationsController@PostEdit'));

    Route::get('/locations/{id}/activate', ['uses' => 'LocationsController@activate']);
    Route::get('/locations/{id}/deactivate', ['uses' => 'LocationsController@deactivate']);
    Route::get('/locations/{id}/destroy', ['uses' => 'LocationsController@destroy']);

    Route::get('/locations/{action}', array( 'uses' => 'LocationsController@GetBulkAction'));
    Route::post('/locations/{action}', array( 'uses' => 'LocationsController@PostBulkAction'));
