...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/member-registrations/edit/{id}', array( 'uses' => 'MemberRegistrationsController@GetEdit'));
    Route::post('/member-registrations/edit/{id}', array( 'uses' => 'MemberRegistrationsController@PostEdit'));
