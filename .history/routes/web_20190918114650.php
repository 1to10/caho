...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/cahotech', array( 'uses' => 'RegistrationsController@listing'));

    Route::get('/cahotech/add/new', array( 'uses' => 'RegistrationsController@Add'));
    Route::post('/cahotech/add/new', array( 'uses' => 'RegistrationsController@postdata'));

    Route::get('/cahotech/edit/{id}', array( 'uses' => 'RegistrationsController@GetEdit'));
    Route::post('/cahotech/edit/{id}', array( 'uses' => 'RegistrationsController@PostEdit'));

    Route::get('/cahotech/{id}/activate', ['uses' => 'RegistrationsController@activate']);
    Route::get('/cahotech/{id}/deactivate', ['uses' => 'RegistrationsController@deactivate']);
    Route::get('/cahotech/{id}/destroy', ['uses' => 'RegistrationsController@destroy']);

    Route::get('/cahotech/{action}', array( 'uses' => 'RegistrationsController@GetBulkAction'));
    Route::post('/cahotech/{action}', array( 'uses' => 'RegistrationsController@PostBulkAction'));
