...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/registrations', array( 'uses' => 'MemberRegistrationsController@listing'));

    Route::get('/registrations/add/new', array( 'uses' => 'MemberRegistrationsController@Add'));
    Route::post('/registrations/add/new', array( 'uses' => 'MemberRegistrationsController@postdata'));

    Route::get('/registrations/edit/{id}', array( 'uses' => 'MemberRegistrationsController@GetEdit'));
    Route::post('/registrations/edit/{id}', array( 'uses' => 'MemberRegistrationsController@PostEdit'));

    Route::get('/registrations/{id}/activate', ['uses' => 'MemberRegistrationsController@activate']);
    Route::get('/registrations/{id}/deactivate', ['uses' => 'MemberRegistrationsController@deactivate']);
    Route::get('/registrations/{id}/destroy', ['uses' => 'MemberRegistrationsController@destroy']);

    Route::get('/registrations/{action}', array( 'uses' => 'MemberRegistrationsController@GetBulkAction'));
    Route::post('/registrations/{action}', array( 'uses' => 'MemberRegistrationsController@PostBulkAction'));
