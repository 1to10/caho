...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/registrations/add/new', array( 'uses' => 'LocationsController@Add'));
    Route::post('/registrations/add/new', array( 'uses' => 'LocationsController@postdata'));

    Route::get('/registrations/edit/{id}', array( 'uses' => 'LocationsController@GetEdit'));
    Route::post('/registrations/edit/{id}', array( 'uses' => 'LocationsController@PostEdit'));

    Route::get('/registrations/{id}/activate', ['uses' => 'LocationsController@activate']);
    Route::get('/registrations/{id}/deactivate', ['uses' => 'LocationsController@deactivate']);
    Route::get('/registrations/{id}/destroy', ['uses' => 'LocationsController@destroy']);

    Route::get('/registrations/{action}', array( 'uses' => 'LocationsController@GetBulkAction'));
    Route::post('/registrations/{action}', array( 'uses' => 'LocationsController@PostBulkAction'));
