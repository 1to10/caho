...
Route::group(array('namespace'=>'FrontEnd'), function(){    
    ...
    Route::post('cahocon', 'AjaxController@cahocon');
    Route::post('cahotech', 'AjaxController@cahotech');
    Route::post('updatecahotech', 'AjaxController@updatecahotech');
    Route::post('updatevalidity', 'AjaxController@updatevalidity');
