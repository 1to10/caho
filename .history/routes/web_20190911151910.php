...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/membership', array( 'uses' => 'LocationsController@listing'));

    Route::get('/membership/edit/{id}', array( 'uses' => 'LocationsController@GetEdit'));
    Route::post('/membership/edit/{id}', array( 'uses' => 'LocationsController@PostEdit'));

    Route::get('/membership/{id}/activate', ['uses' => 'LocationsController@activate']);
    Route::get('/membership/{id}/deactivate', ['uses' => 'LocationsController@deactivate']);

    Route::get('/membership/{action}', array( 'uses' => 'LocationsController@GetBulkAction'));
    Route::post('/membership/{action}', array( 'uses' => 'LocationsController@PostBulkAction'));
