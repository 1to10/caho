...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/pages', array( 'uses' => 'PagesController@listing'));

    Route::get('/pages/add/new', array( 'uses' => 'PagesController@Add'));
    Route::post('/pages/add/new', array( 'uses' => 'PagesController@postdata'));

    Route::get('/pages/edit/{id}', array( 'uses' => 'PagesController@GetEdit'));
    Route::post('/pages/edit/{id}', array( 'uses' => 'PagesController@PostEdit'));

    Route::get('/pages/{id}/activate', ['uses' => 'PagesController@activate']);
    Route::get('/pages/{id}/deactivate', ['uses' => 'PagesController@deactivate']);
    Route::get('/pages/{id}/destroy', ['uses' => 'PagesController@destroy']);

    Route::get('/pages/{action}', array( 'uses' => 'PagesController@GetBulkAction'));
    Route::post('/pages/{action}', array( 'uses' => 'PagesController@PostBulkAction'));
