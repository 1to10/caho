              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('pan_no') ? ' has-error' : '' }}">
                          ...
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="pan_no" type="text" class="form-control" name="pan_no" value="{{ isset($articles->pan_no) ? $articles->pan_no : old('pan_no') }}"  autofocus>
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('gst_no') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="gst_no" type="text" class="form-control" name="gst_no" value="{{ isset($articles->gst_no) ? $articles->gst_no : old('gst_no') }}"  autofocus>
                            </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('ceo_name') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                            <input id="ceo_name" type="text" class="form-control" name="ceo_name" value="{{ isset($articles->ceo_name) ? $articles->ceo_name : old('ceo_name') }}"  autofocus>
                            </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('ceo_email') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                              <input id="ceo_email" type="text" class="form-control" name="ceo_email" value="{{ isset($articles->ceo_email) ? $articles->ceo_email : old('ceo_email') }}"   autofocus>
                            </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group {{ $errors->has('nominated_person') ? ' has-error' : '' }}">
                          <label>NAME OF CONTACT PERSON REPRESENTING ORGANIZATION </label>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                          <input id="nominated_person" type="text" class="form-control" name="nominated_person" value="{{ isset($articles->nominated_person) ? $articles->nominated_person : old('nominated_person') }}"  autofocus>
                          </div>
