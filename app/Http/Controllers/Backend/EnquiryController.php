...
class EnquiryController extends Controller
{
    ...
    {
        //dd($id);
        $artlist = Subscribes::findOrFail($id);
        $artlist->delete();
        return redirect('dashboard/newsletters')->with('success', 'Success! data is deleted successfully.');
    }
    ...
    public function newsletters(Request $request)
    {
        ...
        return 	view('dashboard.Enquiry/newsletters',['articles'=>$artlist]);
    }
