...
//dd($user);
        return 	view('dashboard.role',['roles'=>$role]);
    }
    ...
    public function rolepermission($id){
        ...
        return view('dashboard.rolepermission', compact('actions','role'));
    }
    ...
    public function save($id, Request $request){
        ...
        return redirect('dashboard/role')->with('success', 'Success! Permissions are stored successfully.');
    }
    ...
    {
        return view('dashboard.add-edit-role');
    }
    ...
    public function postRole(Request $request)
    {
        ...
        if($validator->fails())
        {
            return redirect('dashboard/add-edit-role')
        ...
        return redirect('dashboard/role')->with('success', 'Role Added Successfully');
    }
    ...
    public function viewRole(Request $request , $id)
    {
        ...
        return view('dashboard.add-edit-role', ['roles' => $role]);
    ...
    public function editRole(Request $request , $id)
    {
        ...
        if($validator->fails())
        {
            return redirect('dashboard/add-edit-role/'.$id)
                ->withErrors($validator)
                ->withInput();
        }
        //update post data
        ...
        return redirect('dashboard/role')->with('success', 'Role Update Successfully');
    }
