...
class CahotechController extends Controller
{
    ...
    public function postdata(Request $request)
    {
        ...
        return redirect('dashboard/cahotech?programstatus=current')->with('success', 'Registration Added Successfully');
    }
    ...
    public function PostEdit(Request $request , $id)
    {
        ...
        if($validator->fails())
        {
            return redirect('dashboard/cahotech/edit/'.$id)
                ->withErrors($validator)
                ->withInput();
        }
        //update post data
        ...
        return redirect('dashboard/cahotech?programstatus=current')->with('success', 'Registration Update Successfully');
    }
