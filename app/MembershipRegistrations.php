...
class MembershipRegistrations extends Model
{
   protected $table = 'membership_registrations';
    ...
    'org_type','areaof_interest','domain','membership_type','amount','payment_mode','RegistrationNO','MembershipValidity','MemberValidity','MembershipStatus','OrderId','OrderStatus','Transactionid','StatusMessage','status','created_at','updated_at']; 
