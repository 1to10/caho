...
Route::group(array('namespace'=>'Backend','prefix'=>'dashboard','middleware' => 'admin','permission'), function(){
    ...
    Route::get('/membership', array( 'uses' => 'MembershipController@listing'));

    Route::get('/membership/edit/{id}', array( 'uses' => 'MembershipController@GetEdit'));
    Route::post('/membership/edit/{id}', array( 'uses' => 'MembershipController@PostEdit'));

    Route::get('/membership/{id}/activate', ['uses' => 'MembershipController@activate']);
    Route::get('/membership/{id}/deactivate', ['uses' => 'MembershipController@deactivate']);
    ...
    Route::get('/member-registrations/{membershipid}', array( 'uses' => 'MemberRegistrationsController@listing'));

    Route::get('/member-registrations/{membershipid}/add/new', array( 'uses' => 'MemberRegistrationsController@Add'));
    Route::post('/member-registrations/{membershipid}/add/new', array( 'uses' => 'MemberRegistrationsController@postdata'));

    Route::get('/member-registrations/{membershipid}/edit/{id}', array( 'uses' => 'MemberRegistrationsController@GetEdit'));
    Route::post('/member-registrations/{membershipid}/edit/{id}', array( 'uses' => 'MemberRegistrationsController@PostEdit'));

    Route::get('/member-registrations/{membershipid}/{id}/activate', ['uses' => 'MemberRegistrationsController@activate']);
    Route::get('/member-registrations/{membershipid}/{id}/deactivate', ['uses' => 'MemberRegistrationsController@deactivate']);
    Route::get('/member-registrations/{membershipid}/{id}/destroy', ['uses' => 'MemberRegistrationsController@destroy']);

    Route::get('/member-registrations/{membershipid}/{action}', array( 'uses' => 'MemberRegistrationsController@GetBulkAction'));
    Route::post('/member-registrations/{membershipid}/{action}', array( 'uses' => 'MemberRegistrationsController@PostBulkAction'));

    ## Cahotech 

    Route::get('/cahotech', array( 'uses' => 'CahotechController@listing'));

    Route::get('/cahotech/add/new', array( 'uses' => 'CahotechController@Add'));
    Route::post('/cahotech/add/new', array( 'uses' => 'CahotechController@postdata'));

    Route::get('/cahotech/edit/{id}', array( 'uses' => 'CahotechController@GetEdit'));
    Route::post('/cahotech/edit/{id}', array( 'uses' => 'CahotechController@PostEdit'));

    Route::get('/cahotech/{id}/activate', ['uses' => 'CahotechController@activate']);
    Route::get('/cahotech/{id}/deactivate', ['uses' => 'CahotechController@deactivate']);
    Route::get('/cahotech/{id}/destroy', ['uses' => 'CahotechController@destroy']);

    Route::get('/cahotech/{action}', array( 'uses' => 'CahotechController@GetBulkAction'));
    Route::post('/cahotech/{action}', array( 'uses' => 'CahotechController@PostBulkAction'));

    ## cahocon 

    Route::get('/cahocon', array( 'uses' => 'CahoconController@listing'));
